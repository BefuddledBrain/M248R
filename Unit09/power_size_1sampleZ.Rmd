...
output:
  pdf_document:
    ...
    keep_tex: true
    template: "o:/dtma/tex/dt-tma.tex"
---
...
```{r label = "load-pkgs"}
  packages <- c("ggplot2", "latex2exp", "pwr")
xfun::pkg_attach(packages, install = TRUE, message = FALSE)
# "tidyverse", "ggrepel", "ggridges", "ggtext", "ggthemes", 
# "ggstatsplot", "ggforce", "rmarkdown", "xaringan", "xaringanthemer", 
# "kableExtra", "shiny", "corrr", "ggdark", "ggsci", 
# "grid", "gridExtra", "showtext", "rcartocolor", "patchwork", "cowplot", 
# "rvest", "jsonlite", "colorspace", "data.table", 
# "latex2exp", "Hmisc", "broom", "reticulate"
```
\pagestyle{empty}
